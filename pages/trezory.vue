...
export default {
  ...
  components: {
   ...
   data(){
    return{
      catalogText:[
        {link:"E460",text:"Jedna mrdka"},
        {link:"E55",text:"Druhá mrdka"},
        {link:"Kebza",text:"Ahoj Kebzo!"},
      ]
    }
  },
  head() {
